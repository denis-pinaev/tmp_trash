...
PORT = 16544
imgPath = '/home/srv/www/vhosts/like.gale.ru/www/files/media/photos.like/'
...
class Client:
    ...
    def trainPerson(self, frame, id):
        ...
        xml_file = '<?xml version="1.0" encoding="UTF-8"?><methodCall><methodName>learning</methodName><params><login>lLogin</login><password>pPassword</password><user>similarity</user><person_name>%s</person_name></params><id_command>learningWithoutFace</id_command></methodCall>' % id
...
learnAllPersons(1900)
#learnPerson('Ashley_Judd')
'''
images = []
id = "Ершов"
bufAll("./learn/Ershov")
